...
She helps you getting into first gear and tells you the following when you want to accelerate: ::
...
Not long after that she tells you: ::
...
Wouldn't it be easier if instead of telling you the entire procedure she'd tell you the following: ::

  Shift from first to second.
  And after a after she tells you:
  Shift from second to third.
  And not long after that she tells you:
...
gear you start in and the second word she says is the gear you end in? Well luckily there's a way to apply that rule.
